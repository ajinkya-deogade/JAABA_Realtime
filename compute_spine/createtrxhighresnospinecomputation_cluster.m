...
display('Computing Curve Borders and Curve Tips......');
tic

for j=1:numframes
    xcontour{1,j}=Data.contourX(j,:)';
    ycontour{1,j}=Data.contourY(j,:)';
    ...
    [a(j), b(j), theta(j)]=computeinternalvariableshighres(Data.contourX(j,:),Data.contourY(j,:));
end
