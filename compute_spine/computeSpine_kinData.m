...
for t = t_initial:t_final
    ...
    spine = computeSpine(contour, headposition, tailposition);
    kinData_spine.spineX(t,:) = spine(:,1);
    kinData_spine.spineY(t,:) = spine(:,2);
    kinData_spine.contourX(t,:) = x_contour_arena(t,:);
