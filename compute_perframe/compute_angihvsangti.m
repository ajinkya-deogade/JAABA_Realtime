...
filename=[outputfolder, 'absangihvsangti.mat'];
save(filename, 'data', 'units')

units=struct('num','rad','den',[]);
data=angihvsangti;
filename=[outputfolder, 'angihvsangti.mat'];
save(filename, 'data', 'units')
